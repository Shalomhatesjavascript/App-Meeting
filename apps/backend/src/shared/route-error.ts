import { type AuthErrorCode, AuthErrorCodeEnum } from '@repo/shared'
...
const routeStatusByCode = {
  [AuthErrorCodeEnum.AuthenticationRequired]: 401,
  [AuthErrorCodeEnum.Conflict]: 409,
  [AuthErrorCodeEnum.Forbidden]: 403,
  [AuthErrorCodeEnum.InternalError]: 500,
  [AuthErrorCodeEnum.NotFound]: 404,
  [AuthErrorCodeEnum.ValidationError]: 400,
