...
export type InputProps = FieldProps<HTMLInputElement> & Readonly<{ type?: string }>

export type TextareaProps = FieldProps<HTMLTextAreaElement> &
  Readonly<{ maxLength?: number; rows?: number }>
...
function Eye({ size = 16 }: Readonly<{ size?: number }>) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
function EyeOff({ size = 16 }: Readonly<{ size?: number }>) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
function AlertCircle({ size = 16 }: Readonly<{ size?: number }>) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
